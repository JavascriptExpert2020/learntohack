...
function SectionOne () {
  ...
  function componentDidMount()
    ...
    return (
   <>
    <Carousel  id="Carousel" infiniteLoop={true} showIndicators={false} showThumbs={false} showStatus={false} autoPlay dynamicHeight={false}>
        {/*<div >
        ...
        <div className="parent">
          <img src="./img/banner-blog1.jpg" alt="" className="image1"/>
